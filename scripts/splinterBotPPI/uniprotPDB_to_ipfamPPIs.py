...
#
protein_to_pdb_anopheles 	= get_protein_to_pdb_dict("Anopheles gambiae","../../data/splinterBotPPI/uniProt_structures_anopheles_gambiae.tsv")
protein_to_pdb_plasmodium 	= get_protein_to_pdb_dict("Plasmodium falciparum","../../data/splinterBotPPI/uniProt_structures_plasmodium_falciparum.tsv")
...
if os.path.exists("../../data/cache/pdb_to_interactions.p"):
	...
	pdb_to_interactions = pickle.load(open('../../data/splinterBotPPI/cache/pdb_to_interactions.p',"r"))
	interaction_to_url 	= pickle.load(open('../../data/splinterBotPPI/cache/interaction_to_url.p',"r"))
else:
	...
	# save interactions data
	pickle.dump( pdb_to_interactions, open( "../../data/splinterBotPPI/cache/pdb_to_interactions.p", "wb" ) )
	pickle.dump( interaction_to_url,  open( "../../data/splinterBotPPI/cache/interaction_to_url.p", "wb" ) )
